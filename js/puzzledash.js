...
function loadPuzzle(puzzles, id, userHistory, correct, wrong, puzzleEndDateTime, timerId) {
    ...
    function onDrop(source, target) {
        ...
        if (move.san != data.answer[mvNum]) {
            ...
            loadPuzzle(puzzles, id - 2500, userHistory, correct, wrong, puzzleEndDateTime, timerId);
            return 'snapback';
        }
    ...
    function onSnapEnd() {
        ...
        if (mvNum == data.answer.length) {
            ...
            loadPuzzle(puzzles, id + 5001, userHistory, correct, wrong, puzzleEndDateTime, timerId);
            return;
        }
